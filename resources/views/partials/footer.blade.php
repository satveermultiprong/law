    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="widget">
                    ...
                    <address class="s1">
                        ...
                        <span><i class="id-color fa fa-phone fa-lg"></i><a href="tel:1 333 9296">+1 333 9296</a></span>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="ul-style-2">
                    <li><a href="#">Corporate and M&A</a></li>
                    <li><a href="#">Construction and Real Estate</a></li>
                    <li><a href="#">Commercial Duspute Resolution</a></li>
                    <li><a href="#">Employment</a></li>
                    <li><a href="#">Banking and Finance</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
                <h5 class="id-color mb20">Useful Links</h5>
                <ul class="ul-style-2">
    ...
    <div class="subfooter">
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    &copy; 2024 Legalhelpinindia - All Right Reserved.
                </div>
